...
const {
  placedBookingOrder, placedGuestBookingOrder, getBookingOrderByUserId, cancelSelfBookingOrder, getBookingOrderForAdmin, updatedBookingOrderByAdmin
} = require('../controllers/booking.controllers');

// PUBLIC route for guest booking (no login required)
router.route('/guest-booking-order/:id').post(placedGuestBookingOrder);

// route for placed a room booking order (authenticated)
